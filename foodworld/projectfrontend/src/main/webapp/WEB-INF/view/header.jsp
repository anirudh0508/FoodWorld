...
<div class="navbar-header">
				<a href="" class="navbar-brand"><img src="<c:url value='/resources/images/logo.png'></c:url>" alt="FOOD WORLD" height="30px" width="60px"></a>
...
<li><a href="<c:url value='/all/getallproducts'></c:url>">Browse all products</a></li>
  <li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				<li><a href="#">PAROTTA</a></li>
				<li><a href="#">PEPSI</a></li>
				<li><a href="#">VEG RICE</a><li>
